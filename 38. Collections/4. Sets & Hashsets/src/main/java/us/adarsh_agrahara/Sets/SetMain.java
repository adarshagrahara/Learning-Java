package us.adarsh_agrahara.Sets;
...
public class SetMain {
      public static void main(String[] args) {
            ...
            for(int i:intersection){
                  System.out.println(i+ " is the square root of "+Math.sqrt(i)+" and the cube root of "+Math.cbrt(i));
            }
      
            System.out.println("----------------------------------------------------");
            
            Set<String> words = new HashSet<String>();
            String sentence = "one day in the tree of the fox";
